...
Use ivy as the completion engine
Currently disabling ivy in favor of [[Vertico]]
#+BEGIN_SRC disabled
...
Requires installing gopls (go get golang.org/x/tools/gopls@latest)
#+begin_src disabled

(add-hook 'go-mode-hook 'eglot-ensure)

;; From golang emacs tools docs
;; Set eglot-format-buffer as a save hook
;; The depth of -10 places this before eglot's willSave notification
;; so that the notification reports the actual contents that wil be saved
